...
export const FLAT_BUTTON_STYLES = "flex-none transition-all px-4 py-2 rounded-sm text-neutral-700 bg-neutral-300 hover:bg-neutral-200 active:bg-neutral-400";
